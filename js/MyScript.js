...
/*********** SLIDEPANEL TEXT (VARIABLE) **********/
var paneltxt = "<h3>Information</h3>\
...
/*************************************************/
  ...
  // Use to append Home Page slidepanel text by "paneltxt" variable
  ...
  //Retrieving data from "topsellingcars.json" by using getJSON, JSON file is stored locally in "json" folder
  $.getJSON("json/topsellingcars.json", function(cars){
  ...
  function moveTocarsDetailPage(car_name, ranking, car_image, detail, price_from){
      ...
      var CarInformPage = $("" 
                    ...
                    +d_footer_start+"<h4>Price From: "+ price_from + "</h4><span class='right-hand'><a href='#' class='ui-btn ui-btn-inline ui-shadow ui-corner-all ui-btn-a ui-icon-back ui-btn-icon-left' data-rel='back'>Go Back</a></span>" +d_footer_end +"" 
                    );
